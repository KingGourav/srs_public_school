...
<html lang="en">
  ...
  <div><h1>SRS Public School</div>
    <div><h5 style="text-transform: uppercase;"><span>Address :-</span> Near Mauram Mandi,Korihara,Lalganj,<br>Raebareli</h5></div>
    <div><h5><span>Email :-</span>   gpinfotec9@gmail.com</h5></div>
    <div><h5><span>Contact number :-</span>    +91 9889066906</h5></div>
</div>
      <div class="one">
        <h2><i class="fas fa-user-graduate"style="margin-right:1rem;"></i> Total No of TC <span><?php echo ($total); ?></span></h2>
...
while ($result = mysqli_fetch_assoc($data)) {
  echo " <tbody>
    <tr>
     <td><a class='btn btn-success' href='download.php?a=$result[image]'onclick='return checkdelete()'>Download</a></td>
...
?>
  ...
  {
    return confirm('Are you sure you want to Download');
  }
</script>
  </body>
</html>
