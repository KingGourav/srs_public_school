...
<html lang="en">
  ...
  <script src="https://kit.fontawesome.com/9d33041dbc.js" crossorigin="anonymous"></script>
    ...
    <title>Admin Correction Form </title>
  </head>
  <body>
        <div class="container">
      <div class="wrap">
  <div><h1>SRS Public School</div>
    <div><h5 style="text-transform: uppercase;"><span>Address :-</span> Near mauram Mandi Lalganj</h5></div>
    <div><h5><span>Email :-</span>   gpinfotec9@gmail.com</h5></div>
    <div><h5><span>Contact number :-</span>    +91 9889066906</h5></div>
</div>
      <div class="one">
        <h2><i class="fas fa-user-graduate"></i> Total No of Admins <span><?php echo ($total); ?></span></h2>
...
$query = "SELECT * FROM adminlogin WHERE CONCAT(id,username,password) LIKE '%$se%'";
$data = mysqli_query($conn, $query);
$total = mysqli_num_rows($data);
...
while ($result = mysqli_fetch_assoc($data)) {
  echo " <tbody>
    <tr>
     ...
     <td><a href='admindelete.php?a=$result[id]'onclick='return checkdelete()'>Delete</a></td>
